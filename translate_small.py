...
parser.add_argument("--transformer_ffn_emb_dim", type=int, default=1024,
...
parser.add_argument("--checkpoint_dir", type=str, default='/data2/twang/simple-fairseq/all_models/small/')
